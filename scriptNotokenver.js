...
async function loadBookmarks() {
    try {
        ...
        for (const bookmark of bookmarks) {
            ...
            listItem.innerHTML = `
                <a href="#" onclick="openRepoFromBookmark('${bookmark.owner}', '${bookmark.name}')">${bookmark.name}</a>
...
// 북마크에서 리포지토리 클릭 시 모달 닫기 및 리포지토리 모달 열기
function openRepoFromBookmark(owner, repo) {
    closeBookmarkModal();
    openRepoModal(owner, repo);
}
